...
(setq user-full-name "Julius Nugroho"
      user-mail-address "jluuiss@gmail.com")
...
(setq doom-font (font-spec :name "Iosevka" :size 13))
...
;; something for ocamlformat
(defadvice! +ocamlformat-fn-a () :before 'ocamlformat
